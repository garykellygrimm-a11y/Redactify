...
// panel rebuilds its 30k-finding group structure per letter. Moved out of
// Sidebar verbatim when the sidebar gained tabs — the memo matters more
// here than on the tab container, which is cheap to re-render.
